...
RolloutAI.prototype.addCandidateEdge=function(edges,seen,edge){
    if(!edge)return
...
RolloutAI.prototype.getCandidateMax=function(gameData){
    if(gameData.totalScore<=25)return 20
    return this.rolloutCandidateMax
}

RolloutAI.prototype.sampleSafeEdges=function(gameData,maxCount,seed){
...
RolloutAI.prototype.getRandWhereWithRand=function(gameData,number,rand){
...
RolloutAI.prototype.okTryKeepOffensiveMove=function(gameData){
...
RolloutAI.prototype.okWhereWithRand=function(gameData,rand){
...
RolloutAI.prototype.getSingleRegionYieldMove=function(gameData,region){
...
RolloutAI.prototype.playoutScore=function(gameData,seed,rootPlayerId){
...
RolloutAI.prototype.getSafeRolloutCount=function(gameData,candidateCount){
...
RolloutAI.prototype.getDuelRolloutCount=function(gameData){
    var region=gameData.connectedRegion[gameData.scoreRegion[0]]
    if(gameData.totalScore<=25){
...
RolloutAI.prototype.scoreCandidate=function(gameData,edge,rolloutCount,seedBase,rootPlayerId){
...
RolloutAI.prototype.pickByRollout=function(gameData,candidates,rolloutCount,seedBase){
