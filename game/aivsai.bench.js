...
var srcFiles = ['game.js', 'gamedata.js', 'player.js', 'rolloutAI.js', 'rolloutAI.bench.js']
...
var BenchRolloutAI = sandbox.BenchRolloutAI
...
var AI_MAP = {
    ...
    br: { cls: BenchRolloutAI, name: 'BenchRolloutAI', short: 'BR' },
}
...
function printHelp() {
    console.log([
        '用法: node aivsai.js [options]',
        '',
        'AI名称: gr(GreedyRandomAI) ok(OffensiveKeeperAI) ro(RolloutAI)',
        '',
        'Options:',
        '  -1, --ai1 <name>    先手AI (default: ok)',
        '  -2, --ai2 <name>    后手AI (default: gr)',
